...
$routes->group('dashboard', ['filter' => 'authGuard'], function ($routes) {
    ...
    $routes->group('pembimbing', ['filter' => 'authGuardPembimbing'], function ($routes) {
        ...
        $routes->get('remove/from/divisi/(:num)', 'Pembimbing::removeFromMyDivision/$1');
        $routes->get('divisi/saya/(:any)/(:num)', 'Pembimbing::myDivision/$1/$2');
        //File
        ...
        $routes->match(['get', 'post'], 'data/peserta/assign/peserta/(:num)', 'Pembimbing::setPeserta/$1');
    });
    // Notif Routes
    ...
    $routes->group('tu', ['filter' => 'authGuardTU'], function ($routes) {
        // Cetak Nilai
        $routes->get('data/report/(:num)', 'TU::report/$1');
        $routes->get('data/nilai', 'TU::nilai');
        $routes->add('data/nilai/(:num)', 'TU::nilai/$1');
        $routes->get('data/nilai/cetak/(:any)/(:num)', 'TU::cetakPDF/$1/$2');
        //Aktivitas
        $routes->get('data/peserta/detail/(:num)', 'Pembimbing::detailPeserta/$1');
        $routes->get('data/aktivitas', 'Pembimbing::dataAktivitas');
        $routes->get('data/aktivitas/terima/(:num)', 'Pembimbing::terimaAktivitas/$1');
        $routes->get('data/aktivitas/delete/(:num)', 'Pembimbing::hapusAktivitas/$1');
        //Divisi
        $routes->get('/', 'TU::index');
        ...
        $routes->get('data/divisi/delete/(:num)/(:num)', 'TU::delete/$1/$2');
