        ...
        <div class="col">
            <div class="card card-olive shadow">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('dashboard/pembimbing/data/peserta/pesan/' . $content['id']); ?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="inputJK" placeholder="Jenis Kelamin" name="status">
